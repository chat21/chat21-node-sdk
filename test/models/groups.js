...
module.exports = function(chat21){
  ...
  it('should create a group', function(done){
    ...
    .then(function(logindata) {
      chat21.groups.create("test11", [logindata.localId])
        .then(function(data){    
          console.log("chat21-node-sdk join resolve ", data);
        expect(data).to.exist;
        chat21.auth.logout();
        done();    
    })}).catch(function(err, res){
      console.log('chat21-node-sdk ',res);
      chat21.auth.logout();
      done(err);
    });
  });
  ...
  it('should leave a group', function(done){
    ...
    .then(function(logindata) {
      ...
      chat21.groups.leave(logindata.localId, "support-group-LOBsuFytAQ7sOMcq88h")
        .then(function(data){
          console.log("chat21-node-sdk leave resolve ", data);
        expect(data).to.exist;
        chat21.auth.logout();
        done();
      })
  ...
  it('should join a group with token', function(done){
    this.timeout(20000);
     console.log("chat21-node-sdk chat21.firebaseAuth", chat21.firebaseAuth);
    chat21.firebaseAuth.signinWithCustomToken('eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..X_r0I7Jo2CO2Difztv-dxOpf0ldD30PXPC54neZfa4wTVlJqsTUBRWjNjUvt-nNFBhgXc-x2YhivjBGuAewFM39RhkG55Pcz9H2geNQPK_mGkN0WRSaXb-F5obXMMkmUpLQlpk_YhUGU9LtkR6NK5WBCdv9bJcEg2JKmwQ0L_ImvWrOumHF7OXjdPkl76mJhrWyq6Ewdc-fQ9sHW0yWrVTMEumaYA55niYmD2ePFjA9hYl4yzrRh7-p68dzR3TiG6HeRsrblVKHq9KkU9pOWkzDocevmEENV0dOZ9AXj-jEcCCRdI_5Eh6jYf8T0Jeyt6Ui8YeXNkLvoLemdOWS8xQ').then(function(idToken) {
      console.log("chat21-node-sdk idToken", idToken);
